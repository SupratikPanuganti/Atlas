...
Atlas is a mobile-first analytics platform that empowers sports bettors with advanced statistical models to identify mispriced betting lines in real-time. The app combines live pricing engines, transparency-first reporting, and comprehensive betting management tools.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/SupratikPanuganti/Atlas.git
   cd Atlas
   ```
...
**Built with ❤️ for HackGT** | _Empowering smarter sports betting through data transparency_
