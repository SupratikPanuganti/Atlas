           ...
           <View style={styles.linesList}>
             {filteredLines.map((line, index) => (
               <H2HLineCard
                 ...
                 line={line}
                 index={index}
                 onTakeOpposite={() => handleTakeOpposite(line)}
               />
             ))}
           </View>
         )}
...
function CreateLineModal({
 ...
 const handleCreate = () => {
   if (!player.trim() || !customLine.trim() || !stakeCredits.trim()) {
   ...
   if (isNaN(lineValue) || lineValue <= 0) {
     Alert.alert('Error', 'Please enter a valid line value')
     return
   }
   ...
   >
     <SafeAreaView style={{ flex: 1, backgroundColor: colors.surface }}>
       <View style={{
         ...
         <Text style={[{ fontSize: typography.h3.fontSize, color: colors.text }]}>Create Line</Text>
         <TouchableOpacity onPress={onClose}>
           <Text style={[{ fontSize: typography.button.fontSize, color: colors.primary }]}>Cancel</Text>
         </TouchableOpacity>
       </View>
       ...
       <ScrollView style={{ flex: 1, padding: 20 }}>
         <View style={{ gap: 24 }}>
           {/* Sport Selection */}
           <View>
             <Text style={[{ fontSize: typography.label.fontSize, color: colors.text, marginBottom: 8 }]}>Sport</Text>
           ...
           {/* Player Name */}
           <View>
             <Text style={[{ fontSize: typography.label.fontSize, color: colors.text, marginBottom: 8 }]}>Player Name</Text>
             <TextInput
               value={player}
           ...
           {/* Prop Type */}
           <View>
             <Text style={[{ fontSize: typography.label.fontSize, color: colors.text, marginBottom: 8 }]}>Prop Type</Text>
           ...
           {/* Custom Line */}
           <View>
             <Text style={[{ fontSize: typography.label.fontSize, color: colors.text, marginBottom: 8 }]}>Your Line</Text>
           ...
           {/* Stake Credits */}
           <View>
             <Text style={[{ fontSize: typography.label.fontSize, color: colors.text, marginBottom: 8 }]}>
           ...
           {isAnalyzing && (
             <View style={{
               ...
               <Text style={[{ fontSize: typography.caption.fontSize, color: colors.muted }]}>
                 🤖 Analyzing with AI...
               </Text>
             </View>
           )}
           ...
           {geminiAnalysis && (
             <View style={{
               ...
               <Text style={[{ fontSize: typography.caption.fontSize, color: colors.muted, marginBottom: 8 }]}>
                 🤖 AI Analysis
               </Text>
               <Text style={[{ fontSize: typography.small.fontSize, color: colors.text, marginBottom: 8 }]}>
                 {geminiAnalysis.explanation}
               </Text>
               <Text style={[{ fontSize: typography.small.fontSize, color: colors.warning }]}>
                 💡 {geminiAnalysis.riskAssessment}
               </Text>
               {geminiAnalysis.suggestedLine && (
                 <Text style={[{ fontSize: typography.small.fontSize, color: colors.primary, marginTop: 4 }]}>
